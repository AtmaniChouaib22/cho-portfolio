            ...
            {imageList.map((img, idx) => (
              <CarouselItem key={idx}>
                <div className="p-1 h-full">
                  <Card>
                    <CardContent className="flex h-[250px] md:h-[400px] items-center justify-center p-0 relative">
                      <div className="relative w-full h-full min-h-[250px] md:min-h-[400px]">
                        ...
                        />
                        {imageList.length > 1 && (
                          <div className="absolute top-1/2 left-0 right-0 flex justify-between items-center px-2 z-10 -translate-y-1/2">
                            <CarouselPrevious />
                            <CarouselNext />
                          </div>
                        )}
